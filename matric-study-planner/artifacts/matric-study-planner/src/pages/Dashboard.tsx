...
export default function Dashboard() {
  const {
    profile, currentMode, overallProgress, earnedBadges,
  ...
  const isBehind = overallProgress > 0 && overallProgress < expectedProgress - 5;
  const isVeryBehind = overallProgress > 0 && overallProgress < expectedProgress - 20;
