...
test('rejects missing, past, malformed, and far-future placeholder exam dates', () => {
  ...
  assert.equal(postAuthRoute(completedProfile({ examDate: '2026-08-04' }), NOW), '/onboarding');
