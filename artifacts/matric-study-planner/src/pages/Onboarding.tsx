        ...
        <AnimatePresence mode="wait" custom={direction}>
          {step === 1 && (
            ...
            >
              ...
              <p className="onboarding-copy mb-7 text-sm leading-relaxed text-muted-foreground">We’ll use your board for exam-style practice and planning context.</p>
              ...
              <div className="onboarding-list scrollbar-none min-h-0 flex-1 space-y-3 overflow-y-auto overscroll-contain pb-28">
                ...
                <div className="rounded-2xl border border-amber-200/80 bg-amber-50/80 px-4 py-3 text-xs font-semibold leading-relaxed text-amber-900">
                  Choose carefully - this is locked after setup to keep your saved plan consistent.
                </div>
                <AnimatePresence>
